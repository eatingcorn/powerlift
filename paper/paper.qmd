...
\mu_i &= \beta_0 + \beta_1 \times sex_i + \beta_2 \times age_class_i + \beta_3 \times weight_class_kg_i + \beta_4 \times equipment_i \\
...
In these equations, $y_i$ represents the competitiveness of the lift (0 not competitive, 1 competitive), $\pi_i$ represents the probability of the $i$th observation being a competitive lift, $\beta_0$ represents the intercept (log-odds of a competitive lift where the other attributes are 0), $\beta_1$ represents the log-odds of a competitive lift depending on the sex, $\mbox{sex}_i$ represents the sex of the $i$th individual, $\beta_2$ represents how much the log-odds of the competitiveness depending on the age class of the lifter, $\mbox{age_class}_i$ represents the age class of the $i$th lifter, $\beta_3$ represents the log-odds of a competitive lift depending on the weight class of the lifter, and $\mbox{equipment}_i$ represents the equipment usage of the $i$th lifter.
...
```{r}
#| label: table-x
#| fig-cap: The likelihood of a individual to perform a competitive lift
#| echo: false

img <- readPNG('likelihood.png')
grid::grid.raster(img)
